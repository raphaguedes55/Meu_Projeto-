...
public class NovoMotoristaActivity extends AppCompatActivity {
    EditText edit_nome, edit_email,edit_senha,edit_verifica;
    Button cadastrar;
                    ...
                    auth.createUserWithEmailAndPassword(email, password)
                            .addOnCompleteListener(NovoMotoristaActivity.this, new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    ...
                                    Motorista motorista= new Motorista(id,email,nome,password);
                                    databaseMotorista.child(id).setValue(motorista);
