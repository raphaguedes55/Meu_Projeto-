...
public class ColetaDao {
    ...
    public boolean updateColeta(String id, String rotaid,String nomeProdutor, String litragem, String medida,String hora,String tipoAlizarol,String temperatura,String amostra,String retificado,String obs,String motivo,String imagem) {
        DatabaseReference dR = FirebaseDatabase.getInstance().getReference("coletas").child(rotaid).child(id);
        Coletas coletas = new Coletas(id,rotaid,nomeProdutor,litragem,medida,hora,tipoAlizarol,temperatura,amostra,retificado,obs,imagem,motivo);
        dR.setValue(coletas);
        return true;
}
}
